...
if [ ! -z "$LAWYER_USER_ID" ]; then
    ...
    # 16. PUT /api/v1/lawyers/{userId}
    update_data="{\"firstname\":\"María\",\"lastname\":\"González\",\"dni\":\"87654321B\",\"contactInfo\":{\"phoneNumber\":\"+51912345678\",\"address\":\"Calle Secundaria 456\"},\"description\":\"Abogada especializada\"}"
