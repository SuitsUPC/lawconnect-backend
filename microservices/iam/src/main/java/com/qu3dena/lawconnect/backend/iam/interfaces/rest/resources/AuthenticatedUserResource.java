...
/**
 * Resource representing an authenticated user with their ID, username, roles, and authentication token.
 * <p>
 ...
 * @since 1.0.0
 */
public record AuthenticatedUserResource(UUID id, String username, List<String> roles, String token) {
}
